...
Config.discord = {
  ...
  displayOptions = {
    ...
    ["smallImage"] = "other", -- The image displayed in the small image, make sure its the asset name and not a image link
    ["bigImage"] = "other", -- The image displayed in the big image, make sure its the asset name and not a image link
